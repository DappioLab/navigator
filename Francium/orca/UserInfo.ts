...
export class UserInfo implements UserInfoInterface {
    ...
    constructor(
        ...
        this.stableSwapComputeFlag = stableSwapComputeFlag
        this.stableSwapDirection = stableSwapDirection
        this.stableSwapAmount = stableSwapAmount
...
export async function getAllUserPosition(wallet:PublicKey,connection:Connection){
    ...
    const allPosition = await connection.getProgramAccounts(info.lyfOrcaProgramId, config);
