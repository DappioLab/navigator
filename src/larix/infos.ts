...
export async function checkObligationCreated(connection: Connection, wallet: PublicKey, marketId?: PublicKey) {
  let obligationPub = await infos.getObligationId!(marketId ? marketId : LARIX_MARKET_ID_MAIN_POOL, wallet);
