...
export const ADMIN_KEY = new PublicKey(
...
export const QURARRY_MINE_PROGRAM_ID = new PublicKey(
  "QMNeHCGYnLVDn1icRAfQZpjPLBNkfGbSKRB83G5d8KB"
);

export const MINT_WRAPPER = new PublicKey(
  "EVVDA3ZiAjTizemLGXNUN3gb6cffQFEYkFjFZokPmUPz"
);

export const QURARRY_MINT_WRAPPER = new PublicKey(
  "QMWoBmAyJLAsA1Lh9ugMTw2gciTihncciphzdNzdZYV"
);

export const FARM_MINTER = new PublicKey(
  "GEoTC3gN12qHDniaDD7Zxvd5xtcZyEKkTPy42B44s82y"
);

export const IOU_TOKEN_MINT = new PublicKey(
  "iouQcQBAiEXe6cKLS85zmZxUqaCqBdeHFpqKoSz615u"
);

export const CLAIM_FEE_TOKEN_ACCOUNT = new PublicKey(
  "4Snkea6wv3K6qzDTdyJiF2VTiLPmCoyHJCzAdkdTStBK"
);

export const SABER_TOKEN_MINT = new PublicKey(
  "Saber2gLauYim4Mvftnrasomsv6NvAuncvMEZwcLpD1"
);

export const MINTER_PROGRAM_ID = new PublicKey(
